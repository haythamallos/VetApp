...
namespace Vetapp.Engine.BusinessFacadeLayer
{
            ...
            try
            {
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    using (pdfStamper = new PdfStamper(pdfReader, ms, '\0', true))
                    {
                        ...
                        if (ssn != null)
                        {
                            pdfFormFields.SetField(PDFItems.backPDFItems[57].Code, ssn.ToString());
                        }
                        else
                        {
                            pdfFormFields.SetField(PDFItems.backPDFItems[57].Code, back.SocialSecurity);
                        }
            ...
            try
            {
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    using (pdfStamper = new PdfStamper(pdfReader, ms, '\0', true))
                    {
                        ...
                        pdfFormFields.SetField(PDFItems.neckPDFItems[56].Code, m.NameOfPatient);
                        SSN ssn = UtilsString.ParseSSN(m.SocialSecurity);
                        if (ssn != null)
                        {
                            pdfFormFields.SetField(PDFItems.neckPDFItems[55].Code, ssn.ToString());
                        }
                        else
                        {
                        ...
                        pdfFormFields.SetField(PDFItems.neckPDFItems[58].Code, m.S58);
                        ...
                        if (m.S51)
                        {
                            ...
                            pdfFormFields.SetField(PDFItems.neckPDFItems[378].Code, PDFItems.neckPDFItems[378].ExportValue);
                            pdfFormFields.SetField(PDFItems.neckPDFItems[380].Code, PDFItems.neckPDFItems[380].ExportValue);
                        }
                        else
                        {
                        ...
                        {
                            case "RIGHT":
                                pdfFormFields.SetField(PDFItems.neckPDFItems[103].Code, PDFItems.neckPDFItems[103].ExportValue);
                                break;
                            case "LEFT":
                                pdfFormFields.SetField(PDFItems.neckPDFItems[102].Code, PDFItems.neckPDFItems[102].ExportValue);
                                break;
                            default:
                                break;
                        }
                        ...
                        if (!string.IsNullOrEmpty(m.S12AChoice))
                        {
                            ...
                            else if (m.S12AChoice == "MILD")
                            {
                                ...
                                pdfFormFields.SetField(PDFItems.neckPDFItems[305].Code, PDFItems.neckPDFItems[305].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[361].Code, PDFItems.neckPDFItems[361].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[364].Code, PDFItems.neckPDFItems[364].ExportValue);

                                pdfFormFields.SetField(PDFItems.neckPDFItems[331].Code, PDFItems.neckPDFItems[331].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[336].Code, PDFItems.neckPDFItems[336].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[189].Code, "5");
                                pdfFormFields.SetField(PDFItems.neckPDFItems[190].Code, "5");
                                pdfFormFields.SetField(PDFItems.neckPDFItems[191].Code, "5");
                                pdfFormFields.SetField(PDFItems.neckPDFItems[192].Code, "5");
                                ...
                                pdfFormFields.SetField(PDFItems.neckPDFItems[201].Code, PDFItems.neckPDFItems[201].ExportValue);
                                ...
                                pdfFormFields.SetField(PDFItems.neckPDFItems[204].Code, PDFItems.neckPDFItems[204].ExportValue);
                                ...
                                pdfFormFields.SetField(PDFItems.neckPDFItems[277].Code, PDFItems.neckPDFItems[277].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[269].Code, PDFItems.neckPDFItems[269].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[274].Code, PDFItems.neckPDFItems[274].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[272].Code, PDFItems.neckPDFItems[272].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[296].Code, PDFItems.neckPDFItems[296].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[282].Code, PDFItems.neckPDFItems[282].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[295].Code, PDFItems.neckPDFItems[295].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[283].Code, PDFItems.neckPDFItems[283].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[290].Code, PDFItems.neckPDFItems[290].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[288].Code, PDFItems.neckPDFItems[288].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[263].Code, PDFItems.neckPDFItems[263].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[261].Code, PDFItems.neckPDFItems[261].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[254].Code, PDFItems.neckPDFItems[254].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[240].Code, PDFItems.neckPDFItems[240].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[242].Code, PDFItems.neckPDFItems[242].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[249].Code, PDFItems.neckPDFItems[249].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[348].Code, PDFItems.neckPDFItems[348].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[350].Code, PDFItems.neckPDFItems[350].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[357].Code, PDFItems.neckPDFItems[357].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[347].Code, PDFItems.neckPDFItems[347].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[345].Code, PDFItems.neckPDFItems[345].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[338].Code, PDFItems.neckPDFItems[338].ExportValue);
                            ...
                            else if (m.S12AChoice == "MODERATE")
                            {
                                ...
                                pdfFormFields.SetField(PDFItems.neckPDFItems[330].Code, PDFItems.neckPDFItems[330].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[337].Code, PDFItems.neckPDFItems[337].ExportValue);
                                ...
                                pdfFormFields.SetField(PDFItems.neckPDFItems[299].Code, PDFItems.neckPDFItems[299].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[265].Code, PDFItems.neckPDFItems[265].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[279].Code, PDFItems.neckPDFItems[279].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[267].Code, PDFItems.neckPDFItems[267].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[275].Code, PDFItems.neckPDFItems[275].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[271].Code, PDFItems.neckPDFItems[271].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[296].Code, PDFItems.neckPDFItems[296].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[282].Code, PDFItems.neckPDFItems[282].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[295].Code, PDFItems.neckPDFItems[295].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[283].Code, PDFItems.neckPDFItems[283].ExportValue);
                                ...
                                pdfFormFields.SetField(PDFItems.neckPDFItems[288].Code, PDFItems.neckPDFItems[288].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[263].Code, PDFItems.neckPDFItems[263].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[262].Code, PDFItems.neckPDFItems[262].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[253].Code, PDFItems.neckPDFItems[253].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[240].Code, PDFItems.neckPDFItems[240].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[241].Code, PDFItems.neckPDFItems[241].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[250].Code, PDFItems.neckPDFItems[250].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[348].Code, PDFItems.neckPDFItems[348].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[349].Code, PDFItems.neckPDFItems[349].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[358].Code, PDFItems.neckPDFItems[358].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[347].Code, PDFItems.neckPDFItems[347].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[346].Code, PDFItems.neckPDFItems[346].ExportValue);
                                pdfFormFields.SetField(PDFItems.neckPDFItems[329].Code, PDFItems.neckPDFItems[329].ExportValue);
            ...
            try
            {
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    using (pdfStamper = new PdfStamper(pdfReader, ms, '\0', true))
                    {
                        ...
                        pdfFormFields.SetField(PDFItems.shoulderPDFItems[419].Code, PDFItems.shoulderPDFItems[419].ExportValue);
                        pdfFormFields.SetField(PDFItems.shoulderPDFItems[512].Code, PDFItems.shoulderPDFItems[512].ExportValue);
                        pdfFormFields.SetField(PDFItems.shoulderPDFItems[522].Code, PDFItems.shoulderPDFItems[522].ExportValue);
                        ...
                        if (ssn != null)
                        {
                            pdfFormFields.SetField(PDFItems.shoulderPDFItems[14].Code, ssn.ToString());
                        }
                        else
                        {
                        ...
                        if (!m.S63)
                        {
                            ...
                            if ((DoInitialROMLeft) && (DoInitialROMRight))
                            {
                                ...
                                if (SameFinalROMLeft)
                                {
                                    pdfFormFields.SetField(PDFItems.shoulderPDFItems[305].Code, PDFItems.shoulderPDFItems[305].ExportValue);
                                }
                                else
                                {
                            ...
                            else if (DoInitialROMRight)
                            {
                                ...
                                pdfFormFields.SetField(PDFItems.shoulderPDFItems[177].Code, "180");
                                pdfFormFields.SetField(PDFItems.shoulderPDFItems[173].Code, "180");
                                pdfFormFields.SetField(PDFItems.shoulderPDFItems[165].Code, "90");
                                pdfFormFields.SetField(PDFItems.shoulderPDFItems[169].Code, "90");
                            ...
                            else if (DoInitialROMLeft)
                            {
                                ...
                                pdfFormFields.SetField(PDFItems.shoulderPDFItems[156].Code, "180");
                                pdfFormFields.SetField(PDFItems.shoulderPDFItems[152].Code, "180");
                                pdfFormFields.SetField(PDFItems.shoulderPDFItems[144].Code, "90");
                                pdfFormFields.SetField(PDFItems.shoulderPDFItems[148].Code, "90");
                            ...
                            else
                            {
                                ...
                                switch (m.S10ASide)
                                {
                                    ...
                                    case "LEFT":
                                        ...
                                        break;
                                    case "BOTH":
                                        pdfFormFields.SetField(PDFItems.shoulderPDFItems[397].Code, PDFItems.shoulderPDFItems[397].ExportValue);
                                        break;
                                    default:
                                        break;
                                }
            ...
            try
            {
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    using (pdfStamper = new PdfStamper(pdfReader, ms, '\0', true))
                    {
                        ...
                        pdfFormFields.SetField(PDFItems.footPDFItems[48].Code, PDFItems.footPDFItems[48].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[57].Code, PDFItems.footPDFItems[57].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[56].Code, PDFItems.footPDFItems[56].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[83].Code, "Original onset of injury was during active duty service.");
                        pdfFormFields.SetField(PDFItems.footPDFItems[90].Code, PDFItems.footPDFItems[90].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[93].Code, PDFItems.footPDFItems[93].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[87].Code, PDFItems.footPDFItems[87].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[94].Code, PDFItems.footPDFItems[94].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[185].Code, PDFItems.footPDFItems[185].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[181].Code, PDFItems.footPDFItems[181].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[180].Code, PDFItems.footPDFItems[180].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[175].Code, PDFItems.footPDFItems[175].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[231].Code, PDFItems.footPDFItems[231].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[235].Code, PDFItems.footPDFItems[235].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[252].Code, PDFItems.footPDFItems[252].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[264].Code, PDFItems.footPDFItems[264].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[283].Code, PDFItems.footPDFItems[283].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[376].Code, PDFItems.footPDFItems[376].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[404].Code, PDFItems.footPDFItems[404].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[406].Code, PDFItems.footPDFItems[406].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[511].Code, PDFItems.footPDFItems[511].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[506].Code, PDFItems.footPDFItems[506].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[508].Code, PDFItems.footPDFItems[508].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[542].Code, PDFItems.footPDFItems[542].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[547].Code, PDFItems.footPDFItems[547].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[555].Code, PDFItems.footPDFItems[555].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[554].Code, PDFItems.footPDFItems[554].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[562].Code, PDFItems.footPDFItems[562].ExportValue);
                        pdfFormFields.SetField(PDFItems.footPDFItems[560].Code, "Sedentary position is highly recommended due to flareups and sensitivity.");
                        pdfFormFields.SetField(PDFItems.footPDFItems[85].Code, "PT describes pain when walking or running for extended periods and constant soreness and limitation of physical activities.");
                        pdfFormFields.SetField(PDFItems.footPDFItems[91].Code, "PT describes flareups with sensitivity and tenderness which can greatly restrict mobility.");
                        pdfFormFields.SetField(PDFItems.footPDFItems[86].Code, "Please see above remarks");
                        ...
                        {
                            pdfFormFields.SetField(PDFItems.footPDFItems[498].Code, PDFItems.footPDFItems[498].ExportValue);
                            pdfFormFields.SetField(PDFItems.footPDFItems[500].Code, PDFItems.footPDFItems[500].ExportValue);
                            pdfFormFields.SetField(PDFItems.footPDFItems[493].Code, PDFItems.footPDFItems[493].ExportValue);
                            pdfFormFields.SetField(PDFItems.footPDFItems[494].Code, PDFItems.footPDFItems[494].ExportValue);
                            pdfFormFields.SetField(PDFItems.footPDFItems[497].Code, "Please see section 13a");
                        }
                        else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "LEFT"))
                        {
                            pdfFormFields.SetField(PDFItems.footPDFItems[199].Code, PDFItems.footPDFItems[199].ExportValue);
                            pdfFormFields.SetField(PDFItems.footPDFItems[501].Code, PDFItems.footPDFItems[501].ExportValue);
                            pdfFormFields.SetField(PDFItems.footPDFItems[493].Code, PDFItems.footPDFItems[493].ExportValue);
                            pdfFormFields.SetField(PDFItems.footPDFItems[494].Code, PDFItems.footPDFItems[494].ExportValue);
                            pdfFormFields.SetField(PDFItems.footPDFItems[502].Code, "Please see section 13a");
                        }
                        ...
                        if (m.S62)
                        {
                            if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "RIGHT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[79].Code, PDFItems.footPDFItems[79].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "LEFT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[78].Code, PDFItems.footPDFItems[78].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "BOTH"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[77].Code, PDFItems.footPDFItems[77].ExportValue);
                            }
                        }
                        ...
                        if (m.HasPainOnUse)
                        {
                            if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "RIGHT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[135].Code, PDFItems.footPDFItems[135].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[131].Code, PDFItems.footPDFItems[131].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[132].Code, PDFItems.footPDFItems[132].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[128].Code, PDFItems.footPDFItems[128].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "LEFT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[135].Code, PDFItems.footPDFItems[135].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[130].Code, PDFItems.footPDFItems[130].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[132].Code, PDFItems.footPDFItems[132].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[127].Code, PDFItems.footPDFItems[127].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "BOTH"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[135].Code, PDFItems.footPDFItems[135].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[129].Code, PDFItems.footPDFItems[129].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[132].Code, PDFItems.footPDFItems[132].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[126].Code, PDFItems.footPDFItems[126].ExportValue);
                            }
                        }
                        ...
                        if (m.HasSwelling)
                        {
                            if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "RIGHT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[172].Code, PDFItems.footPDFItems[172].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[142].Code, PDFItems.footPDFItems[142].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "LEFT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[172].Code, PDFItems.footPDFItems[172].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[143].Code, PDFItems.footPDFItems[143].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "BOTH"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[172].Code, PDFItems.footPDFItems[172].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[144].Code, PDFItems.footPDFItems[144].ExportValue);
                            }
                        ...
                        if (m.HasCalluses)
                        {
                            if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "RIGHT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[169].Code, PDFItems.footPDFItems[169].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[139].Code, PDFItems.footPDFItems[139].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "LEFT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[169].Code, PDFItems.footPDFItems[169].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[140].Code, PDFItems.footPDFItems[140].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "BOTH"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[169].Code, PDFItems.footPDFItems[169].ExportValue);
                        ...
                        if (m.HasTenderness)
                        {
                            if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "RIGHT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[168].Code, PDFItems.footPDFItems[168].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[136].Code, PDFItems.footPDFItems[136].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[164].Code, PDFItems.footPDFItems[164].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "LEFT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[168].Code, PDFItems.footPDFItems[168].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[137].Code, PDFItems.footPDFItems[137].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[215].Code, PDFItems.footPDFItems[215].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "BOTH"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[168].Code, PDFItems.footPDFItems[168].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[138].Code, PDFItems.footPDFItems[138].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[164].Code, PDFItems.footPDFItems[164].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[215].Code, PDFItems.footPDFItems[215].ExportValue);
                            }
                        ...
                        if (m.HasMarkedDeformity)
                        {
                            if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "RIGHT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[174].Code, PDFItems.footPDFItems[174].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[147].Code, PDFItems.footPDFItems[147].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[184].Code, PDFItems.footPDFItems[184].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[162].Code, PDFItems.footPDFItems[162].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[217].Code, PDFItems.footPDFItems[217].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "LEFT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[174].Code, PDFItems.footPDFItems[174].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[146].Code, PDFItems.footPDFItems[146].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[184].Code, PDFItems.footPDFItems[184].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[161].Code, PDFItems.footPDFItems[161].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[221].Code, PDFItems.footPDFItems[221].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "BOTH"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[174].Code, PDFItems.footPDFItems[174].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[184].Code, PDFItems.footPDFItems[184].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[145].Code, PDFItems.footPDFItems[145].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[160].Code, PDFItems.footPDFItems[160].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[217].Code, PDFItems.footPDFItems[217].ExportValue);
                                pdfFormFields.SetField(PDFItems.footPDFItems[221].Code, PDFItems.footPDFItems[221].ExportValue);
                            }
                        ...
                        {
                            pdfFormFields.SetField(PDFItems.footPDFItems[202].Code, PDFItems.footPDFItems[202].ExportValue);
                            if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "RIGHT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[205].Code, PDFItems.footPDFItems[205].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "LEFT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[204].Code, PDFItems.footPDFItems[204].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "BOTH"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[203].Code, PDFItems.footPDFItems[203].ExportValue);
                            }
                        }

                        if (m.DeviceBuiltupShoes)
                        {
                            pdfFormFields.SetField(PDFItems.footPDFItems[210].Code, PDFItems.footPDFItems[210].ExportValue);
                            if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "RIGHT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[213].Code, PDFItems.footPDFItems[213].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "LEFT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[212].Code, PDFItems.footPDFItems[212].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "BOTH"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[211].Code, PDFItems.footPDFItems[211].ExportValue);
                            }
                        }

                        if (m.DeviceOrthotics)
                        {
                            pdfFormFields.SetField(PDFItems.footPDFItems[206].Code, PDFItems.footPDFItems[206].ExportValue);
                            if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "RIGHT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[209].Code, PDFItems.footPDFItems[209].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "LEFT"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[208].Code, PDFItems.footPDFItems[208].ExportValue);
                            }
                            else if ((!string.IsNullOrEmpty(m.Side)) && (m.Side == "BOTH"))
                            {
                                pdfFormFields.SetField(PDFItems.footPDFItems[207].Code, PDFItems.footPDFItems[207].ExportValue);
                            }
                        }
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    using (pdfStamper = new PdfStamper(pdfReader, ms, '\0', true))
                    {
                        ...
                        if (!string.IsNullOrEmpty(m.lastSleepStudyDate))
                        {
                            ...
                            pdfFormFields.SetField(PDFItems.sleepapneaPDFItems[52].Code, PDFItems.sleepapneaPDFItems[52].ExportValue);
                            pdfFormFields.SetField(PDFItems.sleepapneaPDFItems[49].Code, PDFItems.sleepapneaPDFItems[49].ExportValue);
            ...
            try
            {
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    using (pdfStamper = new PdfStamper(pdfReader, ms, '\0', true))
                    {
                        ...
                        {
                            pdfFormFields.SetField(PDFItems.headachePDFItems[25].Code, PDFItems.headachePDFItems[25].ExportValue);
                            pdfFormFields.SetField(PDFItems.headachePDFItems[11].Code, dt);
                            pdfFormFields.SetField(PDFItems.headachePDFItems[10].Code, m.S25Other);
                        }
                        ...
                        if ((m.S35) && (((m.S23) || (m.S24) || (!string.IsNullOrEmpty(m.S25Other)))))
                        {
                            ...
                            pdfFormFields.SetField(PDFItems.headachePDFItems[48].Code, PDFItems.headachePDFItems[48].ExportValue);
                            pdfFormFields.SetField(PDFItems.headachePDFItems[51].Code, PDFItems.headachePDFItems[51].ExportValue);
                            pdfFormFields.SetField(PDFItems.headachePDFItems[53].Code, PDFItems.headachePDFItems[53].ExportValue);
                        ...
                        else if ((m.S23) || (m.S24) || (!string.IsNullOrEmpty(m.S25Other)))
                        {
                            ...
                            pdfFormFields.SetField(PDFItems.headachePDFItems[49].Code, PDFItems.headachePDFItems[49].ExportValue);
                            pdfFormFields.SetField(PDFItems.headachePDFItems[50].Code, PDFItems.headachePDFItems[50].ExportValue);
                            pdfFormFields.SetField(PDFItems.headachePDFItems[52].Code, PDFItems.headachePDFItems[52].ExportValue);
            ...
            try
            {
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    using (pdfStamper = new PdfStamper(pdfReader, ms, '\0', true))
                    {
                        ...
                        pdfFormFields.SetField(PDFItems.anklePDFItems[342].Code, PDFItems.anklePDFItems[342].ExportValue);
                        ...
                        if (ssn != null)
                        {
                            pdfFormFields.SetField(PDFItems.anklePDFItems[94].Code, ssn.ToString());
                        }
                        else
                        {
    ...
    && (m.S151 == m.S234)
                            ...
                            if (SameFinalROMLeft)
                            {
                                pdfFormFields.SetField(PDFItems.anklePDFItems[238].Code, PDFItems.anklePDFItems[238].ExportValue);
                            }
                            else
                            {
                        ...
                        {
                            // the default for initial LEFT
                            pdfFormFields.SetField(PDFItems.anklePDFItems[121].Code, "45");
                            pdfFormFields.SetField(PDFItems.anklePDFItems[117].Code, "20");
    ...
    && (m.S151 == m.S234)
                        ...
                        if (m.S187)
                        {
                            pdfFormFields.SetField(PDFItems.anklePDFItems[187].Code, PDFItems.anklePDFItems[187].ExportValue);
                            switch (m.S187Side)
                            {
                                case "RIGHT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[221].Code, PDFItems.anklePDFItems[221].ExportValue);
                                    break;
                                case "LEFT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[251].Code, PDFItems.anklePDFItems[251].ExportValue);
                                    break;
                                case "BOTH":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[222].Code, PDFItems.anklePDFItems[222].ExportValue);
                                    break;
                                default:
                                    break;
                            }
                        ...
                        if (m.S223)
                        {
                            pdfFormFields.SetField(PDFItems.anklePDFItems[223].Code, PDFItems.anklePDFItems[223].ExportValue);
                            switch (m.S223Side)
                            {
                                case "RIGHT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[220].Code, PDFItems.anklePDFItems[220].ExportValue);
                                    break;
                                case "LEFT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[250].Code, PDFItems.anklePDFItems[250].ExportValue);
                                    break;
                                case "BOTH":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[219].Code, PDFItems.anklePDFItems[219].ExportValue);
                                    break;
                                default:
                                    break;
                            }
                        ...
                        if (m.S185)
                        {
                            pdfFormFields.SetField(PDFItems.anklePDFItems[185].Code, PDFItems.anklePDFItems[185].ExportValue);
                            switch (m.S185Side)
                            {
                                case "RIGHT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[217].Code, PDFItems.anklePDFItems[217].ExportValue);
                                    break;
                                case "LEFT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[249].Code, PDFItems.anklePDFItems[249].ExportValue);
                                    break;
                                case "BOTH":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[218].Code, PDFItems.anklePDFItems[218].ExportValue);
                                    break;
                                default:
                                    break;
                            }
                        ...
                        if (m.S184)
                        {
                            pdfFormFields.SetField(PDFItems.anklePDFItems[184].Code, PDFItems.anklePDFItems[184].ExportValue);
                            switch (m.S184Side)
                            {
                                case "RIGHT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[216].Code, PDFItems.anklePDFItems[216].ExportValue);
                                    break;
                                case "LEFT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[248].Code, PDFItems.anklePDFItems[248].ExportValue);
                                    break;
                                case "BOTH":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[215].Code, PDFItems.anklePDFItems[215].ExportValue);
                                    break;
                                default:
                                    break;
                            }
                        ...
                        if (m.S231)
                        {
                            pdfFormFields.SetField(PDFItems.anklePDFItems[231].Code, PDFItems.anklePDFItems[231].ExportValue);
                            switch (m.S231Side)
                            {
                                case "RIGHT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[213].Code, PDFItems.anklePDFItems[213].ExportValue);
                                    break;
                                case "LEFT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[247].Code, PDFItems.anklePDFItems[247].ExportValue);
                                    break;
                                case "BOTH":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[214].Code, PDFItems.anklePDFItems[214].ExportValue);
                                    break;
                                default:
                                    break;
                            }
                        ...
                        if (m.S230)
                        {
                            pdfFormFields.SetField(PDFItems.anklePDFItems[230].Code, PDFItems.anklePDFItems[230].ExportValue);
                            switch (m.S230Side)
                            {
                                case "RIGHT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[212].Code, PDFItems.anklePDFItems[212].ExportValue);
                                    break;
                                case "LEFT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[246].Code, PDFItems.anklePDFItems[246].ExportValue);
                                    break;
                                case "BOTH":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[211].Code, PDFItems.anklePDFItems[211].ExportValue);
                                    break;
                                default:
                                    break;
                            }
                        ...
                        if (m.S229)
                        {
                            pdfFormFields.SetField(PDFItems.anklePDFItems[229].Code, PDFItems.anklePDFItems[229].ExportValue);
                            switch (m.S229Side)
                            {
                                case "RIGHT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[209].Code, PDFItems.anklePDFItems[209].ExportValue);
                                    break;
                                case "LEFT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[245].Code, PDFItems.anklePDFItems[245].ExportValue);
                                    break;
                                case "BOTH":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[210].Code, PDFItems.anklePDFItems[210].ExportValue);
                                    break;
                                default:
                                    break;
                            }
                        ...
                        if (m.S228)
                        {
                            pdfFormFields.SetField(PDFItems.anklePDFItems[228].Code, PDFItems.anklePDFItems[228].ExportValue);
                            switch (m.S228Side)
                            {
                                case "RIGHT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[208].Code, PDFItems.anklePDFItems[208].ExportValue);
                                    break;
                                case "LEFT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[244].Code, PDFItems.anklePDFItems[244].ExportValue);
                                    break;
                                case "BOTH":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[207].Code, PDFItems.anklePDFItems[207].ExportValue);
                                    break;
                                default:
                                    break;
                            }
                        ...
                        if (m.S227)
                        {
                            pdfFormFields.SetField(PDFItems.anklePDFItems[227].Code, PDFItems.anklePDFItems[227].ExportValue);
                            switch (m.S227Side)
                            {
                                case "RIGHT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[205].Code, PDFItems.anklePDFItems[205].ExportValue);
                                    break;
                                case "LEFT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[188].Code, PDFItems.anklePDFItems[188].ExportValue);
                                    break;
                                case "BOTH":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[206].Code, PDFItems.anklePDFItems[206].ExportValue);
                                    break;
                                default:
                                    break;
                            }
                        ...
                        if (m.S189)
                        {
                            pdfFormFields.SetField(PDFItems.anklePDFItems[189].Code, PDFItems.anklePDFItems[189].ExportValue);
                            switch (m.S189Side)
                            {
                                case "RIGHT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[203].Code, PDFItems.anklePDFItems[203].ExportValue);
                                    break;
                                case "LEFT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[204].Code, PDFItems.anklePDFItems[204].ExportValue);
                                    break;
                                case "BOTH":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[202].Code, PDFItems.anklePDFItems[202].ExportValue);
                                    break;
                                default:
                                    break;
                            }
                        ...
                        if (m.S201)
                        {
                            pdfFormFields.SetField(PDFItems.anklePDFItems[201].Code, PDFItems.anklePDFItems[201].ExportValue);
                            switch (m.S201Side)
                            {
                                case "RIGHT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[199].Code, PDFItems.anklePDFItems[199].ExportValue);
                                    break;
                                case "LEFT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[190].Code, PDFItems.anklePDFItems[190].ExportValue);
                                    break;
                                case "BOTH":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[200].Code, PDFItems.anklePDFItems[200].ExportValue);
                                    break;
                                default:
                                    break;
                            }
                        ...
                        if (m.S191)
                        {
                            pdfFormFields.SetField(PDFItems.anklePDFItems[191].Code, PDFItems.anklePDFItems[191].ExportValue);
                            switch (m.S191Side)
                            {
                                case "RIGHT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[197].Code, PDFItems.anklePDFItems[197].ExportValue);
                                    break;
                                case "LEFT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[198].Code, PDFItems.anklePDFItems[198].ExportValue);
                                    break;
                                case "BOTH":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[196].Code, PDFItems.anklePDFItems[196].ExportValue);
                                    break;
                                default:
                                    break;
                            }
                        ...
                        if (m.S195)
                        {
                            pdfFormFields.SetField(PDFItems.anklePDFItems[195].Code, PDFItems.anklePDFItems[195].ExportValue);
                            switch (m.S195Side)
                            {
                                case "RIGHT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[193].Code, PDFItems.anklePDFItems[193].ExportValue);
                                    break;
                                case "LEFT":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[192].Code, PDFItems.anklePDFItems[192].ExportValue);
                                    break;
                                case "BOTH":
                                    pdfFormFields.SetField(PDFItems.anklePDFItems[194].Code, PDFItems.anklePDFItems[194].ExportValue);
                                    break;
                                default:
                                    break;
                            }
            ...
            try
            {
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    using (pdfStamper = new PdfStamper(pdfReader, ms, '\0', true))
                    {
                        ...
                        {
                            pdfFormFields.SetField(PDFItems.kneePDFItems[165].Code, PDFItems.kneePDFItems[165].ExportValue);
                            pdfFormFields.SetField(PDFItems.kneePDFItems[168].Code, m.S165Other);
                            pdfFormFields.SetField(PDFItems.kneePDFItems[164].Code, dt);
                            sb.Append(m.S165Other);
                            switch (m.S165Side)
                            {
                                case "RIGHT":
                                    pdfFormFields.SetField(PDFItems.kneePDFItems[150].Code, PDFItems.kneePDFItems[150].ExportValue);
                                    sb.Append(", Right");
                                    break;
                                case "LEFT":
                                    pdfFormFields.SetField(PDFItems.kneePDFItems[161].Code, PDFItems.kneePDFItems[161].ExportValue);
                                    sb.Append(", Left");
                                    break;
                                case "BOTH":
                                    pdfFormFields.SetField(PDFItems.kneePDFItems[162].Code, PDFItems.kneePDFItems[162].ExportValue);
                                    sb.Append(", Bilateral");
                                    break;
                                default:
                                    break;
                        ...
                        {
                            // set the RIGHT
                            pdfFormFields.SetField(PDFItems.kneePDFItems[171].Code, m.S171);
                            pdfFormFields.SetField(PDFItems.kneePDFItems[175].Code, m.S175);
                            ...
                            // Set the LEFT
                            pdfFormFields.SetField(PDFItems.kneePDFItems[146].Code, m.S146);
                            pdfFormFields.SetField(PDFItems.kneePDFItems[142].Code, m.S142);
    ...
    && (m.S188 == m.S284)
                            ...
                            if (SameFinalROMRight)
                            {
                                pdfFormFields.SetField(PDFItems.kneePDFItems[316].Code, PDFItems.kneePDFItems[316].ExportValue);
                            }
                            else
                            {
                                pdfFormFields.SetField(PDFItems.kneePDFItems[315].Code, PDFItems.kneePDFItems[315].ExportValue);
                                pdfFormFields.SetField(PDFItems.kneePDFItems[313].Code, m.S313);
                                pdfFormFields.SetField(PDFItems.kneePDFItems[314].Code, m.S314);
                            }
                            ...
                            {
                                pdfFormFields.SetField(PDFItems.kneePDFItems[289].Code, PDFItems.kneePDFItems[289].ExportValue);
                                pdfFormFields.SetField(PDFItems.kneePDFItems[287].Code, m.S287);
                        ...
                        {
                            // the default for initial LEFT
                            pdfFormFields.SetField(PDFItems.kneePDFItems[146].Code, "140");
                            pdfFormFields.SetField(PDFItems.kneePDFItems[142].Code, "140");
    ...
    && (m.S202 == m.S314)
                        ...
                        {
                            // the default for initial RIGHT
                            pdfFormFields.SetField(PDFItems.kneePDFItems[130].Code, "140");
                            pdfFormFields.SetField(PDFItems.kneePDFItems[134].Code, "140");
            ...
            try
            {
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    using (pdfStamper = new PdfStamper(pdfReader, ms, '\0', true))
                    {
                        ...
                        if (ssn != null)
                        {
                            pdfFormFields.SetField(PDFItems.hipPDFItems[76].Code, ssn.ToString());
                        }
                        else
                        {
    ...
    && (m.S190 == m.S317)
                            ...
                            if (SameFinalROMRight)
                            {
                                pdfFormFields.SetField(PDFItems.hipPDFItems[285].Code, PDFItems.hipPDFItems[285].ExportValue);
                            }
                            else
                            {
                            ...
                            if (SameFinalROMLeft)
                            {
                                pdfFormFields.SetField(PDFItems.hipPDFItems[323].Code, PDFItems.hipPDFItems[323].ExportValue);
                            }
                            else
                            {
                                pdfFormFields.SetField(PDFItems.hipPDFItems[324].Code, PDFItems.hipPDFItems[324].ExportValue);
                        ...
                        {
                            // the default for initial LEFT
                            pdfFormFields.SetField(PDFItems.hipPDFItems[154].Code, "125");
                            pdfFormFields.SetField(PDFItems.hipPDFItems[144].Code, "30");
                            pdfFormFields.SetField(PDFItems.hipPDFItems[145].Code, "45");
                            pdfFormFields.SetField(PDFItems.hipPDFItems[148].Code, "25");
                            pdfFormFields.SetField(PDFItems.hipPDFItems[134].Code, "60");
                            pdfFormFields.SetField(PDFItems.hipPDFItems[140].Code, "40");
    ...
    && (m.S168 == m.S275)
                        ...
                        else if (DoInitialROMLeft)
                        {
                            ...
                            pdfFormFields.SetField(PDFItems.hipPDFItems[123].Code, "125");
                            pdfFormFields.SetField(PDFItems.hipPDFItems[113].Code, "30");
                            pdfFormFields.SetField(PDFItems.hipPDFItems[114].Code, "45");
                            pdfFormFields.SetField(PDFItems.hipPDFItems[117].Code, "25");
                            pdfFormFields.SetField(PDFItems.hipPDFItems[103].Code, "60");
                            pdfFormFields.SetField(PDFItems.hipPDFItems[109].Code, "40");
    ...
    && (m.S190 == m.S317)
                        ...
                        if (m.S262)
                        {
                            pdfFormFields.SetField(PDFItems.hipPDFItems[262].Code, PDFItems.hipPDFItems[262].ExportValue);
                        }
                        if (m.S216)
                        {
                            pdfFormFields.SetField(PDFItems.hipPDFItems[216].Code, PDFItems.hipPDFItems[216].ExportValue);
                        }
                        ...
                        if (m.S264)
                        {
                            pdfFormFields.SetField(PDFItems.hipPDFItems[263].Code, m.S264Other);
                            pdfFormFields.SetField(PDFItems.hipPDFItems[264].Code, PDFItems.hipPDFItems[264].ExportValue);
                        }

                        if (m.S416)
                        {
                            pdfFormFields.SetField(PDFItems.hipPDFItems[416].Code, PDFItems.hipPDFItems[416].ExportValue);
                        ...
                        {
                            pdfFormFields.SetField(PDFItems.hipPDFItems[417].Code, PDFItems.hipPDFItems[417].ExportValue);
                        }

                        pdfFormFields.SetField(PDFItems.hipPDFItems[295].Code, "5");
                        pdfFormFields.SetField(PDFItems.hipPDFItems[293].Code, "5");
                        pdfFormFields.SetField(PDFItems.hipPDFItems[294].Code, "5");
                        pdfFormFields.SetField(PDFItems.hipPDFItems[334].Code, "5");
                        pdfFormFields.SetField(PDFItems.hipPDFItems[326].Code, "5");
                        pdfFormFields.SetField(PDFItems.hipPDFItems[327].Code, "5");

                        pdfFormFields.SetField(PDFItems.hipPDFItems[299].Code, PDFItems.hipPDFItems[299].ExportValue);
                        pdfFormFields.SetField(PDFItems.hipPDFItems[332].Code, PDFItems.hipPDFItems[332].ExportValue);
                        pdfFormFields.SetField(PDFItems.hipPDFItems[343].Code, PDFItems.hipPDFItems[343].ExportValue);
                        pdfFormFields.SetField(PDFItems.hipPDFItems[405].Code, PDFItems.hipPDFItems[405].ExportValue);
                        pdfFormFields.SetField(PDFItems.hipPDFItems[407].Code, PDFItems.hipPDFItems[407].ExportValue);

                        pdfFormFields.SetField(PDFItems.hipPDFItems[479].Code, PDFItems.hipPDFItems[479].ExportValue);
                        pdfFormFields.SetField(PDFItems.hipPDFItems[477].Code, "Sedentary occupation highly suggested due to flareups and severity of symptoms.");

                        pdfFormFields.SetField(PDFItems.hipPDFItems[106].Code, PDFItems.hipPDFItems[106].ExportValue);
                        pdfFormFields.SetField(PDFItems.hipPDFItems[137].Code, PDFItems.hipPDFItems[137].ExportValue);
                        pdfFormFields.SetField(PDFItems.hipPDFItems[162].Code, PDFItems.hipPDFItems[162].ExportValue);
                        pdfFormFields.SetField(PDFItems.hipPDFItems[169].Code, PDFItems.hipPDFItems[169].ExportValue);
                        pdfFormFields.SetField(PDFItems.hipPDFItems[173].Code, PDFItems.hipPDFItems[173].ExportValue);
                        pdfFormFields.SetField(PDFItems.hipPDFItems[199].Code, PDFItems.hipPDFItems[199].ExportValue);
                        pdfFormFields.SetField(PDFItems.hipPDFItems[196].Code, PDFItems.hipPDFItems[196].ExportValue);
                        pdfFormFields.SetField(PDFItems.hipPDFItems[212].Code, PDFItems.hipPDFItems[212].ExportValue);
                        pdfFormFields.SetField(PDFItems.hipPDFItems[184].Code, PDFItems.hipPDFItems[184].ExportValue);
                        pdfFormFields.SetField(PDFItems.hipPDFItems[209].Code, PDFItems.hipPDFItems[209].ExportValue);
                        pdfFormFields.SetField(PDFItems.hipPDFItems[178].Code, PDFItems.hipPDFItems[178].ExportValue);

                        if ((DoInitialROMLeft) && (DoInitialROMRight))
                        {
                            pdfFormFields.SetField(PDFItems.hipPDFItems[179].Code, PDFItems.hipPDFItems[179].ExportValue);
                            pdfFormFields.SetField(PDFItems.hipPDFItems[181].Code, PDFItems.hipPDFItems[181].ExportValue);
                        ...
                        {
                            pdfFormFields.SetField(PDFItems.hipPDFItems[194].Code, PDFItems.hipPDFItems[194].ExportValue);
                            pdfFormFields.SetField(PDFItems.hipPDFItems[201].Code, PDFItems.hipPDFItems[201].ExportValue);
                            pdfFormFields.SetField(PDFItems.hipPDFItems[323].Code, PDFItems.hipPDFItems[323].ExportValue);

                            pdfFormFields.SetField(PDFItems.hipPDFItems[179].Code, PDFItems.hipPDFItems[179].ExportValue);
                            pdfFormFields.SetField(PDFItems.hipPDFItems[181].Code, PDFItems.hipPDFItems[181].ExportValue);
                            pdfFormFields.SetField(PDFItems.hipPDFItems[201].Code, PDFItems.hipPDFItems[201].ExportValue);
                            pdfFormFields.SetField(PDFItems.hipPDFItems[203].Code, PDFItems.hipPDFItems[203].ExportValue);
                        ...
                        {
                            pdfFormFields.SetField(PDFItems.hipPDFItems[164].Code, PDFItems.hipPDFItems[164].ExportValue);
                            pdfFormFields.SetField(PDFItems.hipPDFItems[180].Code, PDFItems.hipPDFItems[180].ExportValue);
                            pdfFormFields.SetField(PDFItems.hipPDFItems[285].Code, PDFItems.hipPDFItems[285].ExportValue);

                            pdfFormFields.SetField(PDFItems.hipPDFItems[180].Code, PDFItems.hipPDFItems[180].ExportValue);
                            pdfFormFields.SetField(PDFItems.hipPDFItems[182].Code, PDFItems.hipPDFItems[182].ExportValue);
                            pdfFormFields.SetField(PDFItems.hipPDFItems[204].Code, PDFItems.hipPDFItems[204].ExportValue);
                            pdfFormFields.SetField(PDFItems.hipPDFItems[202].Code, PDFItems.hipPDFItems[202].ExportValue);
        ...
        private void SetContributingFactorsHip(AcroFields pdfFormFields, bool f, string side, int indCheck, int indRight, int indLeft, int indBoth)
        {
            if (f)
            {
                pdfFormFields.SetField(PDFItems.hipPDFItems[indCheck].Code, PDFItems.hipPDFItems[indCheck].ExportValue);
                switch (side)
                {
                    case "RIGHT":
                        pdfFormFields.SetField(PDFItems.hipPDFItems[indRight].Code, PDFItems.hipPDFItems[indRight].ExportValue);
                        break;
                    case "LEFT":
                        pdfFormFields.SetField(PDFItems.hipPDFItems[indLeft].Code, PDFItems.hipPDFItems[indLeft].ExportValue);
                        break;
                    case "BOTH":
                        pdfFormFields.SetField(PDFItems.hipPDFItems[indBoth].Code, PDFItems.hipPDFItems[indBoth].ExportValue);
                        break;
                    default:
                        break;
                }
        ...
        private void SetField_S12ABrace_Hip(HipModel m, AcroFields pdfFormFields)
        {
            if (m.S418)
            {
                pdfFormFields.SetField(PDFItems.hipPDFItems[418].Code, PDFItems.hipPDFItems[418].ExportValue);
                switch (m.S418Choice)
                {
                    case "OCCASIONAL":
                        pdfFormFields.SetField(PDFItems.hipPDFItems[436].Code, PDFItems.hipPDFItems[436].ExportValue);
                        break;
                    case "REGULAR":
                        pdfFormFields.SetField(PDFItems.hipPDFItems[440].Code, PDFItems.hipPDFItems[440].ExportValue);
                        break;
                    case "CONSTANT":
                        pdfFormFields.SetField(PDFItems.hipPDFItems[441].Code, PDFItems.hipPDFItems[441].ExportValue);
                        break;
                    default:
                        break;
                }
        ...
        private void SetField_S12ACrutches_Hip(HipModel m, AcroFields pdfFormFields)
        {
            if (m.S430)
            {
                pdfFormFields.SetField(PDFItems.hipPDFItems[430].Code, PDFItems.hipPDFItems[430].ExportValue);

                switch (m.S430Choice)
                {
                    case "OCCASIONAL":
                        pdfFormFields.SetField(PDFItems.hipPDFItems[429].Code, PDFItems.hipPDFItems[429].ExportValue);
                        break;
                    case "REGULAR":
                        pdfFormFields.SetField(PDFItems.hipPDFItems[428].Code, PDFItems.hipPDFItems[428].ExportValue);
                        break;
                    case "CONSTANT":
                        pdfFormFields.SetField(PDFItems.hipPDFItems[427].Code, PDFItems.hipPDFItems[427].ExportValue);
                        break;
                    default:
                        break;
                }
        ...
        private void SetField_S12ACane_Hip(HipModel m, AcroFields pdfFormFields)
        {
            if (m.S419)
            {
                pdfFormFields.SetField(PDFItems.hipPDFItems[419].Code, PDFItems.hipPDFItems[419].ExportValue);

                switch (m.S419Choice)
                {
                    case "OCCASIONAL":
                        pdfFormFields.SetField(PDFItems.hipPDFItems[424].Code, PDFItems.hipPDFItems[424].ExportValue);
                        break;
                    case "REGULAR":
                        pdfFormFields.SetField(PDFItems.hipPDFItems[425].Code, PDFItems.hipPDFItems[425].ExportValue);
                        break;
                    case "CONSTANT":
                        pdfFormFields.SetField(PDFItems.hipPDFItems[426].Code, PDFItems.hipPDFItems[426].ExportValue);
                        break;
                    default:
                        break;
                }
        ...
        private void SetField_S12AWalker_Hip(HipModel m, AcroFields pdfFormFields)
        {
            if (m.S423)
            {
                pdfFormFields.SetField(PDFItems.hipPDFItems[423].Code, PDFItems.hipPDFItems[423].ExportValue);

                switch (m.S423Choice)
                {
                    case "OCCASIONAL":
                        pdfFormFields.SetField(PDFItems.hipPDFItems[422].Code, PDFItems.hipPDFItems[422].ExportValue);
                        break;
                    case "REGULAR":
                        pdfFormFields.SetField(PDFItems.hipPDFItems[421].Code, PDFItems.hipPDFItems[421].ExportValue);
                        break;
                    case "CONSTANT":
                        pdfFormFields.SetField(PDFItems.hipPDFItems[420].Code, PDFItems.hipPDFItems[420].ExportValue);
                        break;
                    default:
                        break;
                }
            ...
            try
            {
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    using (pdfStamper = new PdfStamper(pdfReader, ms, '\0', true))
                    {
                        ...
                        // correction defaults
                        pdfFormFields.SetField(PDFItems.elbowPDFItems[146].Code, PDFItems.elbowPDFItems[146].ExportValue);
                        pdfFormFields.SetField(PDFItems.elbowPDFItems[297].Code, PDFItems.elbowPDFItems[297].ExportValue);
                        pdfFormFields.SetField(PDFItems.elbowPDFItems[264].Code, PDFItems.elbowPDFItems[264].ExportValue);
                        pdfFormFields.SetField(PDFItems.elbowPDFItems[421].Code, PDFItems.elbowPDFItems[421].ExportValue);
                        pdfFormFields.SetField(PDFItems.elbowPDFItems[423].Code, PDFItems.elbowPDFItems[423].ExportValue);
                        pdfFormFields.SetField(PDFItems.elbowPDFItems[458].Code, PDFItems.elbowPDFItems[458].ExportValue);


                        pdfFormFields.SetField(PDFItems.elbowPDFItems[83].Code, m.NameOfPatient);
                        SSN ssn = UtilsString.ParseSSN(m.SocialSecurity);
                        if (ssn != null)
                        {
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[82].Code, ssn.ToString());
                        }
                        else
                        {
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[82].Code, m.SocialSecurity);
                        }

                        pdfFormFields.SetField(PDFItems.elbowPDFItems[59].Code, PDFItems.elbowPDFItems[59].ExportValue);
                        pdfFormFields.SetField(PDFItems.elbowPDFItems[66].Code, PDFItems.elbowPDFItems[66].ExportValue);
                        pdfFormFields.SetField(PDFItems.elbowPDFItems[67].Code, PDFItems.elbowPDFItems[67].ExportValue);
                        ...
                        if (m.S72)
                        {
                            ...
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[72].Code, PDFItems.elbowPDFItems[72].ExportValue);
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[56].Code, dt);
                        ...
                        if (m.S73)
                        {
                            ...
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[73].Code, PDFItems.elbowPDFItems[73].ExportValue);
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[55].Code, dt);
                            if (ICDCodes.elbowICDCodes.TryGetValue(diagnosis.ToLower(), out icdcode))
                            {
                        ...
                        if (m.S74)
                        {
                            ...
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[74].Code, PDFItems.elbowPDFItems[74].ExportValue);
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[47].Code, dt);
                            if (ICDCodes.elbowICDCodes.TryGetValue(diagnosis.ToLower(), out icdcode))
                            {
                        ...
                        if (m.S75)
                        {
                            ...
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[75].Code, PDFItems.elbowPDFItems[75].ExportValue);
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[46].Code, dt);
                            if (ICDCodes.elbowICDCodes.TryGetValue(diagnosis.ToLower(), out icdcode))
                            {
                        ...
                        if (m.S76)
                        {
                            ...
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[76].Code, PDFItems.elbowPDFItems[76].ExportValue);
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[38].Code, dt);
                            if (ICDCodes.elbowICDCodes.TryGetValue(diagnosis.ToLower(), out icdcode))
                            {
                        ...
                        if (m.S77)
                        {
                            ...
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[77].Code, PDFItems.elbowPDFItems[77].ExportValue);
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[37].Code, dt);
                            if (ICDCodes.elbowICDCodes.TryGetValue(diagnosis.ToLower(), out icdcode))
                            {
                        ...
                        if (m.S78)
                        {
                            ...
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[78].Code, PDFItems.elbowPDFItems[78].ExportValue);
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[29].Code, dt);
                            if (ICDCodes.elbowICDCodes.TryGetValue(diagnosis.ToLower(), out icdcode))
                            {
                        ...
                        if (m.S79)
                        {
                            ...
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[79].Code, PDFItems.elbowPDFItems[79].ExportValue);
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[28].Code, dt);
                            if (ICDCodes.elbowICDCodes.TryGetValue(diagnosis.ToLower(), out icdcode))
                            {
                        ...
                        if (m.S80)
                        {
                            ...
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[80].Code, PDFItems.elbowPDFItems[80].ExportValue);
                            pdfFormFields.SetField(PDFItems.elbowPDFItems[20].Code, dt);
                            if (ICDCodes.elbowICDCodes.TryGetValue(diagnosis.ToLower(), out icdcode))
                            {
    ...
    && (m.S147 == m.S254)
                        ...
                        {
                            case "RIGHT":
                                pdfFormFields.SetField(PDFItems.elbowPDFItems[102].Code, PDFItems.elbowPDFItems[102].ExportValue);
                                break;
                            case "LEFT":
                                pdfFormFields.SetField(PDFItems.elbowPDFItems[105].Code, PDFItems.elbowPDFItems[105].ExportValue);
                                break;
                            default:
                                break;
                        }
                        ...
                        {
                            case "BOTH":
                                pdfFormFields.SetField(PDFItems.elbowPDFItems[182].Code, PDFItems.elbowPDFItems[182].ExportValue);
                                pdfFormFields.SetField(PDFItems.elbowPDFItems[180].Code, PDFItems.elbowPDFItems[180].ExportValue);
                                break;
                            default:
                                break;
                        }
    ...
    public class PdfFill
    {
        ...
        public static void SetClaimedConditionsSection(AcroFields pdfFormFields, bool p1, string p2, int p3, int p4, int p5, StringBuilder p6, string p7, int p8, int p9, int p10, Dictionary<int, PDFItem> items, Dictionary<string, ICDCode> icdcodes)
        {
            ...
            {
                diagnosis = p2;
                pdfFormFields.SetField(items[p3].Code, items[p3].ExportValue);
                pdfFormFields.SetField(items[p4].Code, dt);
                if ((icdcodes != null) && (p5 > 0))
                {
                    if (icdcodes.TryGetValue(diagnosis.ToLower(), out icdcode))
                    {
                        pdfFormFields.SetField(items[p5].Code, icdcode.RefNumber);
                    }
                }
                p6.Append(diagnosis);
                switch (p7)
                {
                    case "RIGHT":
                        pdfFormFields.SetField(items[p8].Code, items[p8].ExportValue);
                        p6.Append(", Right");
                        break;
                    case "LEFT":
                        pdfFormFields.SetField(items[p9].Code, items[p9].ExportValue);
                        p6.Append(", Left");
                        break;
                    case "BOTH":
                        pdfFormFields.SetField(items[p10].Code, items[p10].ExportValue);
                        p6.Append(", Bilateral");
                        break;
                    default:
                        break;
        ...
        {
            pdfFormFields.SetField(items[p1].Code, items[p1].ExportValue);
            pdfFormFields.SetField(items[p2].Code, items[p2].ExportValue);
            pdfFormFields.SetField(items[p3].Code, items[p3].ExportValue);
        }
        ...
        public static void SetContributingFactorsSection(AcroFields pdfFormFields, Dictionary<int, PDFItem> items, bool pCheck, string pSide, int pInd, int indRight, int indLeft, int indBoth)
        {
            if (pCheck)
            {
                pdfFormFields.SetField(items[pInd].Code, items[pInd].ExportValue);
                switch (pSide)
                {
                    case "RIGHT":
                        pdfFormFields.SetField(items[indRight].Code, items[indRight].ExportValue);
                        break;
                    case "LEFT":
                        pdfFormFields.SetField(items[indLeft].Code, items[indLeft].ExportValue);
                        break;
                    case "BOTH":
                        pdfFormFields.SetField(items[indBoth].Code, items[indBoth].ExportValue);
                        break;
                    default:
                        break;
                }
