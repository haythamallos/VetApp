...
/*********************** CUSTOM NON-META END *********************/
		...
		public static readonly string ENTITY_NAME = "EnumContentState"; //Table name to abstract
...
//		private string _strOrderByEnum = "ASC";
		...
		public string SP_ENUM_NAME = "spContentStateEnum"; //Enum sp name

		/// <summary>HasError is a Property in the ContentState Class of type bool</summary>
		...
		public EnumContentState()
		{
		}
		/// <summary>Contructor takes 1 parameter: SqlConnection</summary>
		public EnumContentState(SqlConnection conn)
		{
			_conn = conn;
		}
		...
		/// <summary>Property of type ContentState. Returns the next ContentState in the list</summary>
		private ContentState _nextTransaction
		{
			get
			{
				ContentState o = null;
		...
		public override string ToString() 
		{
			...
			sbReturn.Append(TAG_CONTENT_STATE_ID + ":  " + ContentStateID.ToString() + "\n");
