...
namespace Vetapp.Engine.BusinessAccessLayer
{
	...
	public class BusUser
	{
		...
		private const String REGEXP_ISVALID_INTERNAL_NOTES = BusValidationExpressions.REGEX_TYPE_PATTERN_NVARCHAR255;
		private const String REGEXP_ISVALID_USER_MESSAGE = BusValidationExpressions.REGEX_TYPE_PATTERN_NVARCHAR255;
...
/*********************** CUSTOM NON-META END *********************/
	...
	{
		return (Get(0, 0, new DateTime(), new DateTime(), new DateTime(), new DateTime(), null, null, null, null, null, null, null, null, null, null, false, false, null, null, false, new DateTime(), new DateTime(), new DateTime(), new DateTime(), null, null));
	}
	...
	{
		return (Get(lUserID , 0, new DateTime(), new DateTime(), new DateTime(), new DateTime(), null, null, null, null, null, null, null, null, null, null, false, false, null, null, false, new DateTime(), new DateTime(), new DateTime(), new DateTime(), null, null));
	}
