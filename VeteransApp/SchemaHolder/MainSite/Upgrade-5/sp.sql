...
SELECT  [jct_user_content_type_id], [date_created], [date_modified], [user_id], [side_id], [content_type_id], [rating], [is_connected] 
FROM [jct_user_content_type] 
WHERE jct_user_content_type_id = @JctUserContentTypeID
RETURN 0
------------------------------------------------
...
AS
      ...
      AND ((@IsConnected IS NULL) OR ([is_connected] LIKE @IsConnected))
